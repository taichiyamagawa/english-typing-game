...
export const categoryLabelEn: Record<string, string> = {
  trivia_short:                        "💡 Short Trivia",
  trivia_long:                         "📚 Long Trivia",
  phrase:                              "💬 Phrases (All)",
  phrase_all:                          "💬 Phrases (All)",
  phrase_daily:                        "💬 Daily Phrases",
  phrase_present_simple:               "💬 Present Simple",
  phrase_present_continuous:           "💬 Present Continuous",
  phrase_present_perfect:              "💬 Present Perfect",
  phrase_present_perfect_continuous:   "💬 Present Perfect Continuous",
  phrase_past_simple:                  "💬 Past Simple",
  phrase_past_continuous:              "💬 Past Continuous",
  phrase_past_perfect:                 "💬 Past Perfect",
  phrase_past_perfect_continuous:      "💬 Past Perfect Continuous",
  phrase_future_simple:                "💬 Future Simple",
  phrase_future_continuous:            "💬 Future Continuous",
  phrase_future_perfect:               "💬 Future Perfect",
  phrase_future_perfect_continuous:    "💬 Future Perfect Continuous",
  phrase_tag:                          "💬 Tag Questions",
  phrase_passive:                      "💬 Passive Voice",
  phrase_subjunctive:                  "💬 Subjunctive",
  phrase_imperative:                   "💬 Imperatives",
  phrase_infinitive:                   "💬 Infinitives",
  phrase_gerund:                       "💬 Gerunds",
  word_all:                            "✏️ Words (All)",
  word_biology:       "🦋 Biology",
  word_nature:        "🌿 Nature",
  word_weather_space: "🌌 Weather & Space",
  word_food:          "🍎 Food",
